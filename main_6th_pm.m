%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Dynamic Response Estimation (perturbation on mechanical power)
...
addpath('functions');
load data/psat_td_data_6th_nonunif_0731.mat
% load data/psat_td_data_6th_nonunif_load_0731.mat
% load data/psat_td_data_6th_nonunif_load.mat
t_ambient = Varout.t;
...
load data/impz_resp_6th_nonunif_power_0730.mat
psat_temp = Varout;
...
for i  = 1 : n_line
    ...
    flow_resp_temp = flow_resp_temp ./ 16;
